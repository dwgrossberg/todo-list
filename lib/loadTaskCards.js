...
var loadTaskCards = function () {
        ...
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          try {
            (function () {
              ...
              _taskMaster["default"].taskList[taskIndex].changeTitle(mutation.target.textContent); // Save changes to localStorage
        ...
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
          ...
          try {
            (function () {
              ...
              _taskMaster["default"].taskList[taskIndex].changeDetails(mutation.target.textContent); // Save changes to localStorage
  ...
  var run = function run(taskList) {
    ...
    taskList.forEach(function (task) {
      ...
      taskTitle.innerHTML = "".concat(task.task.title);
      ...
      taskDetails.innerHTML = "".concat(task.task.details);
