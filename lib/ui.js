    ...
    var callback = function callback(mutationsList) {
      ...
      try {
        var _loop = function _loop() {
          ...
          _taskMaster["default"].projectList[projectIndex].changeName(oldProjectName, mutation.target.textContent);

          console.log(_taskMaster["default"].projectList[projectIndex].project); // Update localStorage
